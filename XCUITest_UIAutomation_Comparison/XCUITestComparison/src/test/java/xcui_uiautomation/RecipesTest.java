...
import static xcui_uiautomation.RecipesCrossVersionLocators.*;
...
public class RecipesTest implements WebDriverProvider {
	...
	@BeforeMethod
	public void beforeMethod(String mcm, String mcmUser, String mcmPassword, String browserName, String platformName, String platformVersion, @Optional("Appium") String automationName, ITestContext context, Method method)
			throws IOException {
		...
		PerfectoExecutionContext perfectoExecutionContext = new PerfectoExecutionContext.PerfectoExecutionContextBuilder()
                .withProject(new Project("Project", "1.0")).withContextTags(context.getCurrentXmlTest().getName()).withWebDriver(driver).build();
